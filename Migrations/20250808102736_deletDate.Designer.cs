...
namespace GameZone.Migrations
{
    ...
    [Migration("20250808102736_deletDate")]
    partial class deletDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameZone.Models.DeleetedGame", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GameZone.Models.DeleetedGame", b =>
                {
                    b.HasOne("GameZone.Models.Game", "DeletedGame")
                        .WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DeletedGame");
                });
